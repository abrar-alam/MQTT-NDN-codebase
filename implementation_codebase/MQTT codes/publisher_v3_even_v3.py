...
"""Mod. version of "publisher_v3_even.py" so that this uses another cloud broker"""
...
client = mqtt.Client("PP2") #create new instance
...
client.connect("j0e54ec1.us-east-1.emqx.cloud",  15201) #connect to broker
